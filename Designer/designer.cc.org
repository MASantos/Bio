...
void AllPositions::computeSingleEnergies() {
	...
	//cout << "total aspot " << _template_aspot << endl;
...
int main() {
	...
	cout<<"Designer27 created by Lorenz Wernisch and later revised by Alfonso Jaramillo. Version "<<__DATE__<<endl;
	char buffer[300];
	string des_cmd = "end";
	...
	do {
		...
		for (;;) {
			...
			//}
				...
				cout << " TEST: calling cm_energy..." << endl;
                		charmm_computations.cmBuild();
                		//charmm_computations.writePDB("alx.pdb");
                		//exitError("STOP after writePDB");
                		charmm_computations.computeSurface();
				...
				cout << " TEST: call to cm_energy done." << endl;
			}
